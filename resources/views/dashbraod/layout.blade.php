                                ...
                                <tbody>
                                    <tr>
                                        <td class="text-xs-center">
                                            <div class="avatar">
                                                <img src="{{ asset('assets/img/avatars/1.jpg') }}" class="img-avatar" alt="admin@bootstrapmaster.com" src="{{ asset('assets/img/avatars/1.jpg') }}">
                                        ...
                                        <td class="text-xs-center">
                                            <img src="{{ asset('assets/img/flags/USA.png') }}" alt="USA" style="height:24px;" src="{{ asset('assets/img/flags/USA.png') }}">
                                        </td>
                                        <td>
                                            <div class="clearfix">
                                                <div class="pull-left">
                                    ...
                                    <tr>
                                        <td class="text-xs-center">
                                            <div class="avatar">
                                                <img src="{{ asset('assets/img/avatars/2.jpg') }}" class="img-avatar" alt="admin@bootstrapmaster.com" src="{{ asset('assets/img/avatars/2.jpg') }}">
                                        ...
                                        <td class="text-xs-center">
                                            <img src="{{ asset('assets/img/flags/Brazil.png') }}" alt="Brazil" style="height:24px;" src="{{ asset('assets/img/flags/Brazil.png') }}">
                                        </td>
                                        <td>
                                            <div class="clearfix">
                                                <div class="pull-left">
                                    ...
                                    <tr>
                                        <td class="text-xs-center">
                                            <div class="avatar">
                                                <img src="{{ asset('assets/img/avatars/3.jpg') }}" class="img-avatar" alt="admin@bootstrapmaster.com" src="{{ asset('assets/img/avatars/3.jpg') }}">
                                        ...
                                        <td class="text-xs-center">
                                            <img src="{{ asset('assets/img/flags/India.png') }}" alt="India" style="height:24px;" src="{{ asset('assets/img/flags/India.png') }}">
                                        </td>
                                        <td>
                                            <div class="clearfix">
                                                <div class="pull-left">
                                    ...
                                    <tr>
                                        <td class="text-xs-center">
                                            <div class="avatar">
                                                <img src="{{ asset('assets/img/avatars/4.jpg')}}" class="img-avatar" alt="admin@bootstrapmaster.com" src="{{ asset('assets/img/avatars/4.jpg') }}">
                                        ...
                                        <td class="text-xs-center">
                                            <img src="{{ asset('assets/img/flags/France.png') }}" alt="France" style="height:24px;" src="{{ asset('assets/img/flags/France.png') }}">
                                        </td>
                                        <td>
                                            <div class="clearfix">
                                                <div class="pull-left">
                                    ...
                                    <tr>
                                        <td class="text-xs-center">
                                            <div class="avatar">
                                                <img src="{{ asset('assets/img/avatars/5.jpg') }}" class="img-avatar" alt="admin@bootstrapmaster.com" src="{{ asset('assets/img/avatars/5.jpg') }}">
                                                <span class="avatar-status tag-success"></span>
                                            </div>
                                        </td>
                                        <td>
                                        ...
                                        <td class="text-xs-center">
                                            <img src="{{ asset('assets/img/flags/Spain.png') }}" alt="Spain" style="height:24px;" src="{{ asset('assets/img/flags/Spain.png') }}">
                                        </td>
                                        <td>
                                            <div class="clearfix">
                                                <div class="pull-left">
                                    ...
                                    <tr>
                                        <td class="text-xs-center">
                                            <div class="avatar">
                                                <img src="{{ asset('assets/img/avatars/6.jpg') }}" class="img-avatar" alt="admin@bootstrapmaster.com" src="{{ asset('assets/img/avatars/6.jpg') }}">
                                                <span class="avatar-status tag-danger"></span>
                                            </div>
                                        </td>
                                        <td>
                                        ...
                                        <td class="text-xs-center">
                                            <img src="{{ asset('assets/img/flags/Poland.png') }}" alt="Poland" style="height:24px;" src="{{ asset('assets/img/flags/Poland.png') }}">
                                        </td>
                                        <td>
                                            <div class="clearfix">
                                                <div class="pull-left">
